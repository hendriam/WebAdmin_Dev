<div class="col-md-12 mb-4 mt-4">
  <div class="card">
    <div class="card-header">
      <strong>Form Isi DBS</strong>
    </div>

    <form action="" method="post" id="dbs_form" enctype="multipart/form-data" class="form-horizontal">
    <div class="card-body">
      ...
      <div class="form-group row">
        <label class="col-md-1 col-form-label" for="text-input">Nominal DBS</label>
        <div class="col-md-3">
    ...
    <div class="card-footer">
      <button type="submit" id="saldo_submit" class="btn btn-sm btn-primary" onclick="submitDbsForm(event)"><i class="fa fa-dot-circle-o"></i> Submit</button>
